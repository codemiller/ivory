 ...
 *  ☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠
 *
 *  This module does almost everything wrong, use with absolute caution, and do
 *  not rely on it existing for very long. There are a lot of outstanding issues
 *  such as serialization, use of tuples instead of a parametric priority, mix of
 *  storage, operation and parsing code, it is also created lazily in a way that
 *  obscurses and delays errors incorrectly. Any "operation aware" functions need
 *  to be removed / replaced with, functions that have some decent semantics. Any
 *  paths used in map/reduce to have unboxed paths.
 *
 *  https://github.com/ambiata/ivory/issues/267
 *
 *  ☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠☠
 *
 */
 ...
 */
case class Entities(entities: HashMap[String, Array[Int]]) {
   ...
   *         priority
   */
  def keepBestFacts(entityId: String, facts: Iterable[(Priority, Fact)]): Array[(Int, Priority, Option[Fact])] = {
...
object Entities {
  ...
  def deserialiseEntities(ref: ReferenceIO): ResultTIO[Entities] = {
    ...
    ref.run(store => path => store.bytes.read(path).flatMap(bytes =>
      ResultT.safe(Entities(new ObjectInputStream(new ByteArrayInputStream(bytes.toArray)).readObject.asInstanceOf[HashMap[String, Array[Int]]]))))
  }
