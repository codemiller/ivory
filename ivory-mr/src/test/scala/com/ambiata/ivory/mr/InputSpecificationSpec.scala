...
"""
  ...
  class MapperX extends Mapper[NullWritable, NullWritable, NullWritable, NullWritable]
  class MapperY extends Mapper[NullWritable, NullWritable, NullWritable, NullWritable]
}
